...
/**
 * BannertxController implements the CRUD actions for AdressUser model.
 */
class BannertxController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Bannertx::find()->orderBy(['id'=>SORT_DESC]),
        ]);
    ...
    {
        if (($model = Bannertx::findOne($id)) !== null) {
            return $model;
        }
