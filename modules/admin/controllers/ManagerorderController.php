...
/**
 * ManagerorderController implements the CRUD actions for AdressUser model.
 */
class ManagerorderController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => ManagerOrder::find()->orderBy(['id'=>SORT_DESC]),
        ]);
    ...
    {
        if (($model = ManagerOrder::findOne($id)) !== null) {
            return $model;
        }
