...
/**
 * CategorybannerController implements the CRUD actions for AdressUser model.
 */
class CategorybannerController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => CategoryBanner::find()->orderBy(['id'=>SORT_DESC]),
        ]);
    ...
    {
        if (($model = CategoryBanner::findOne($id)) !== null) {
            return $model;
        }
