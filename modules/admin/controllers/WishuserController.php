...
/**
 * WishuserController implements the CRUD actions for AdressUser model.
 */
class WishuserController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => WishUser::find()->orderBy(['id'=>SORT_DESC]),
        ]);
    ...
    {
        if (($model = WishUser::findOne($id)) !== null) {
            return $model;
        }
