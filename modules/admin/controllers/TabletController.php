...
/**
 * TabletController implements the CRUD actions for AdressUser model.
 */
class TabletController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Tablet::find()->orderBy(['id'=>SORT_DESC]),
        ]);
        ...
        $image = Image::find()->where(['category'=>'Tablets'])->orderBy(['id'=>SORT_DESC])->all();
