...
/**
 * CameraController implements the CRUD actions for AdressUser model.
 */
class CameraController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Camera::find()->orderBy(['id'=>SORT_DESC]),
        ]);
        ...
        $image = Image::find()->where(['category'=>'Camera'])->orderBy(['id'=>SORT_DESC])->all();
