...
/**
 * AudioController implements the CRUD actions for AdressUser model.
 */
class AudioController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Audio::find()->orderBy(['name_type_of_subcategory'=>'asdas']),
        ]);
        ...
        $image = Image::find()->where(['category'=>'Audio'])->orderBy(['id'=>SORT_DESC])->all();
