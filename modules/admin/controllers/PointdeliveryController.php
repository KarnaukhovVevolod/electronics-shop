...
/**
 * PointdeliveryController implements the CRUD actions for AdressUser model.
 */
class PointdeliveryController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Pointdelivery::find()->orderBy(['id'=>SORT_DESC]),
        ]);
    ...
    {
        if (($model = Pointdelivery::findOne($id)) !== null) {
            return $model;
        }
