...
/**
 * BannerimController implements the CRUD actions for AdressUser model.
 */
class BannerimController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Bannerim::find()->orderBy(['id'=>SORT_DESC]),
        ]);
    ...
    {
        if (($model = Bannerim::findOne($id)) !== null) {
            return $model;
        }
