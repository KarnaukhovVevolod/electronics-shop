...
/**
 * AdressuserController implements the CRUD actions for AdressUser model.
 */
class AdressuserController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => AdressUser::find()->orderBy(['id'=>SORT_DESC]),
        ]);
    ...
    {
        if (($model = AdressUser::findOne($id)) !== null) {
            return $model;
        }
