...
/**
 * HistoryuserController implements the CRUD actions for AdressUser model.
 */
class HistoryuserController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => HistoryUser::find()->orderBy(['id'=>SORT_DESC]),
        ]);
    ...
    {
        if (($model = HistoryUser::findOne($id)) !== null) {
            return $model;
        }
