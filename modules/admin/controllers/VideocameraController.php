...
/**
 * VideocameraController implements the CRUD actions for AdressUser model.
 */
class VideocameraController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => VideoCamera::find()->orderBy(['name_type_of_subcategory'=>'SC']),
        ]);
        ...
        $image = Image::find()->where(['category'=>'Videocamera'])->orderBy(['id'=>SORT_DESC])->all();
    ...
    {
        if (($model = VideoCamera::findOne($id)) !== null) {
            return $model;
        }
