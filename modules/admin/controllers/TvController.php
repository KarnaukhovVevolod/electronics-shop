...
/**
 * TvController implements the CRUD actions for AdressUser model.
 */
class TvController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Tv::find()->orderBy(['name_type_of_subcategory'=>'sdfsd']),
        ]);
        ...
        $image = Image::find()->where(['category'=>'Tv'])->orderBy(['id'=>SORT_DESC])->all();
