...
<?php $items = ['like_product'=>'Понравилась продукция','number_purchases'=>'Кол-во покупок','price_sort'=>'Цена для сортировки',
    ...
    'discount'=>'Cкидка','marketing_products'=>'Маркетинг продукта','type_camera'=>'Тип камеры','video_recording_speed' => 'Скорость видеозаписи','description'=>'Описание продукта',
    'date'=>'Дата',] ?>
...
<?= $form->field($update_form, 'table')->textInput(['value'=>'videocamera']) ?>
</div>
