...
<?php $items = ['like_product'=>'Понравилась продукция','number_purchases'=>'Кол-во покупок','price_sort'=>'Цена для сортировки',
    ...
    'discount'=>'Cкидка','marketing_products'=>'Маркетинг продукта','type_notebook'=>'Тип ноутбука','amount_ram'=>'Объём оперативной памяти','description'=>'Описание продукта',
    'date'=>'Дата','number_core'=>'Кол-во ядер процессора','total_memory'=>'Общий объём памяти','screen_diagonal'=>'Диагональ экрана',] ?>
...
<?= $form->field($update_form, 'table')->textInput(['value'=>'notebook']) ?>
</div>
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    'view'   => function ($url, $model, $key) {
                        $view = Html::a('',['/admin/notebook/view','id'=>$model['id']],
                                ['class' => 'glyphicon glyphicon-eye-open']);
                        return $view;
                    },
                    'update' => function ($url, $model, $key) {
                        $update = Html::a('',['/admin/notebook/update','id'=>$model['id']], 
                                ['class' => 'glyphicon glyphicon-pencil']);                       
                        return $update; 
                    },
                    'delete' => function ($url, $model, $key) {
                        $delete = Html::a('',['/admin/notebook/delete','id'=>$model['id']], 
