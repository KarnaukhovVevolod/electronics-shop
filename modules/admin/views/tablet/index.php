...
<?php $items = ['like_product'=>'Понравилась продукция','number_purchases'=>'Кол-во покупок','price_sort'=>'Цена для сортировки',
    ...
    'discount'=>'Cкидка','marketing_products'=>'Маркетинг продукта','type_tablet'=>'Тип планшета','amount_ram'=>'Объём оперативной памяти','description'=>'Описание продукта',
    'date'=>'Дата','number_sim'=>'Кол-во sim карт','internal_memory'=>'Общий объём памяти','screen_diagonal'=>'Диагональ экрана',] ?>
...
<?= $form->field($update_form, 'table')->textInput(['value'=>'tablet']) ?>
</div>
