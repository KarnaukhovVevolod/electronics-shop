...
<?php $items = ['like_product'=>'Понравилась продукция','number_purchases'=>'Кол-во покупок','price_sort'=>'Цена для сортировки',
    ...
    'discount'=>'Cкидка','marketing_products'=>'Маркетинг продукта','type_tv'=>'Тип телевизора','screen_diagonal'=>'Диагональ экрана','screen_resolution'=>'Разрешение экрана','description'=>'Описание продукта',
    'date'=>'Дата',] ?>
...
<?= $form->field($update_form, 'table')->textInput(['value'=>'tv']) ?>
</div>
