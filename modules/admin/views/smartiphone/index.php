...
<?php $items = ['like_product'=>'Понравилась продукция','number_purchases'=>'Кол-во покупок','price_sort'=>'Цена для сортировки',
    ...
    'discount'=>'Cкидка','marketing_products'=>'Маркетинг продукта','type_device'=>'Тип устройства','screen_diagonal'=>'Диагональ экрана','description'=>'Описание продукта',
    'date'=>'Дата','internal_memory'=>'Внутренняя память','amount_ram'=>'Оперативная память','camera_resolution'=>'Разрешение камеры','number_core'=>'Кол-во ядер',
    'color'=>'Цвет','series'=>'Серия',] ?>
...
<?= $form->field($update_form, 'table')->textInput(['value'=>'smartiphone']) ?>
</div>
