...
/**
 * AdressController implements the CRUD actions for AdressUser model.
 */
class AdressController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Name_models::find()->orderBy(['id'=>SORT_DESC]),
        ]);
    ...
    {
        if (($model = Name_models::findOne($id)) !== null) {
            return $model;
        }
