                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <div class="top-link">
                                                        <ul class="link">
                                                                ...
                                                                <?php //endif; ?>
                                                                <li><a href="<?= Url::to(['/electronics/account']) ?>"><i class="fa fa-unlock-alt"></i> Зарегистрироваться</a></li>
                                                        </ul>
                                                </div>
                                                <!-- End Top-Link -->
                                        </div>
                                                                                    ...
                                                                                    <div style="display: none"> 
                                                                                        ...
                                                                                        <div class="cart-inner-bottom">
                                                                                                ...
                                                                                                <span class="cart-button-top">
                                                                                                        <a href="<?= Url::to(['/electronics/cart']) ?>">Просмотреть корзину</a>
                                                                                                        <a href="<?= Url::to(['/electronics/checkout']) ?>">Оформление заказа</a>
                                    ...
                                    <div class="modal-body">
                                            <div class="modal-product">
                                                    ...
                                                    <div class="product-info">
                                                            ...
                                                            <a href="shop.html" class="see-all">Узнать подробнее</a> <div style="float:right">В наличии <span class="number_of_product_modal"></span></div>
